            ...
            <div class="card-header border-0 pt-6">
                <div class="card-toolbar">
                    <div class="d-flex align-items-center position-relative my-1" data-kt-user-table-toolbar="base">
                        <h3><i class="ki-user"></i>Laporan Monitoring Training Pekerja</h3>
                    </div>
                </div>
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" data-kt-menu-placement="bottom-start">
                            ...
                            <div class="px-7 py-5" data-kt-user-table-filter="form">
                                ...
                                <div class="mb-10">
                                    <label class="form-label fs-6 fw-semibold">Training:</label>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Training</th>
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        <tr>
                            ...
                            <td>PT Kilang Pertamina Internasiona</td>
                            <td>Dumai UP</td>
